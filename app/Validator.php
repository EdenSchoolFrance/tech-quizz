...
class Validator {
    ...
    private $messages = [
        ...
        "majuscule" => "Le champ dois contenir au moins une lettre majuscule !",
        "minuscule" => "Le champ dois contenir au moins une lettre minuscule !",
        "specialChars" => "Le champ doit contenir au moins un caractère spécial !",
