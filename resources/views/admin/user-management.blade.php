...
<main class="flex">
    <div class="bg-white h-[100vh] w-[16%]">
        ...
        <div class="flex flex-col ms-8">
            <div
                class="flex bg-[#4880FF] w-[150px] py-3 px-4 text-white rounded-lg mb-4 text-lg items-center font-rubik">
                <svg class="me-4"
                     width="20"
                     viewBox="0 0 18 16"
                     fill="none"
    ...
    <div class="my-24 mx-10 font-rubik w-[100%]">
        ...
        <div class="flex justify-end">
            <a href="/create-user" class="text-white bg-[#4880FF] w-[159px] h-[46px] flex justify-center items-center rounded-lg">New User</a>
        </div>
        <div class="mt-12">
                        ...
                        <table class="w-[100%] border-separate border-spacing-10">
                            ...
                            @foreach($users as $user)
                                <tr class="mt-10">
                                    ...
                                    <td><a href="/user-details" class="bg-[#48FFB9] py-3 px-16 rounded-lg">Details</a></td>
                                    <td><a href="/update-user" class="bg-[#8280FF] py-3 px-16 rounded-lg">Update</a></td>
                                    <td><a href="/delete-user" class="bg-[#F93C65] py-3 px-16 rounded-lg">Delete</a></td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
