    ...
    <div class="flex-1 p-8">
        <div class="container mx-auto max-w-4xl">
            ...
            <div class="bg-white dark:bg-[#3B4D66] shadow-md rounded-lg p-6 mb-8">
                <h2 class="text-2xl font-semibold mb-6">Create New Quiz</h2>
                <form action="/quiz/store" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="description" id="description" class="w-full px-4 py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white" rows="5"><?= isset($_SESSION['old']['description']) ? $_SESSION['old']['description'] : '' ?></textarea>
                    </div>
                    <div class="flex justify-center">
                        <button type="submit" class="px-6 py-3 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors">Create Quiz</button>
                    </div>
                </form>
            </div>
        </div>
