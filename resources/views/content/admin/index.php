                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white dark:bg-[#3B4D66] divide-y divide-gray-200">
                        <?php foreach ($quizzes as $quiz): ?>
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium dark:text-gray-200 text-gray-900"><?= $quiz->getTitle() ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm dark:text-gray-300 text-gray-500"><?= substr($quiz->getDescription(), 0, 50) . (strlen($quiz->getDescription()) > 50 ? '...' : '') ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm dark:text-gray-300 text-gray-500"><?= $quiz->getCreatedAt() ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    ...
                                    <a href="/dashboard/quiz/edit/<?= $quiz->getId() ?>" class="text-indigo-300 hover:text-indigo-400 mr-3">Edit</a>
                ...
                <table class="min-w-full divide-y divide-gray-200 ">
                    ...
                    <tbody class="bg-white dark:bg-[#3B4D66] divide-y divide-gray-200">
                        <?php foreach ($users as $user): ?>
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-gray-200"><?= $user->getUsername() ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm dark:text-gray-300 text-gray-500"><?= $user->getEmail()?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm dark:text-gray-300 text-gray-500"><?= $user->getRole() ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm dark:text-gray-300 text-gray-500"><?= $user->getCreatedAt() ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <a href="/content/admin/result/<?= $user->getId() ?>" class="text-blue-600 hover:text-blue-900 mr-3">View</a>
                                    <a href="/dashboard/user/edit/<?= $user->getId() ?>" class="text-indigo-300 hover:text-indigo-400 mr-3">Edit</a>
