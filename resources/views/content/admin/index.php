        ...
        <div class="container mx-auto">
            ...
            <?php if (isset($editQuiz)): ?>
                <div class="bg-white dark:bg-[#3B4D66] shadow-md rounded-lg p-6 mb-8">
                    ...
                    <form action="/dashboard/quiz/update/<?= $editQuiz->getId() ?>" method="POST">
                        <div class="mb-4">
                            <label for="title" class="block text-sm font-medium text-gray-700 dark:text-gray-400 mb-1">Quiz Title *</label>
                        ...
                        <div class="mb-4">
                            <label for="description" class="block text-sm font-medium text-gray-700 dark:text-gray-400 mb-1">Description</label>
            ...
            <?php elseif (isset($editUser)): ?>
                <div class="bg-white dark:bg-[#3B4D66] shadow-md rounded-lg p-6 mb-8">
                    ...
                    <form action="/dashboard/user/update/<?= $editUser->getId() ?>" method="POST">
                        ...
                        <div class="mb-4">
                            <label for="email" class="block text-sm font-medium text-gray-700 dark:text-gray-400 mb-1">Email *</label>
                        ...
                        <div class="mb-4">
                            <label for="role" class="block text-sm font-medium text-gray-700 dark:text-gray-400 mb-1">Role *</label>
            ...
            <div class="bg-white dark:bg-[#3B4D66] shadow-md rounded-lg p-6 mb-8">
                ...
                <?php if (empty($quizzes)): ?>
                    <p class="text-gray-500 dark:text-gray-100">You haven't created any quizzes yet.</p>
                <?php else: ?>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white dark:bg-[#3B4D66] divide-y divide-gray-200">
                                <?php foreach ($quizzes as $quiz): ?>
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-gray-100"><?= $quiz->getTitle() ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-200"><?= substr($quiz->getDescription(), 0, 50) . (strlen($quiz->getDescription()) > 50 ? '...' : '') ?></td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            ...
                                            <a href="/dashboard/quiz/edit/<?= $quiz->getId() ?>" class="text-indigo-600 dark:text-indigo-300 hover:text-indigo-900 mr-3">Edit</a>
            ...
            <div class="bg-white  dark:bg-[#3B4D66] shadow-md rounded-lg p-6">
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white dark:bg-[#3B4D66] divide-y divide-gray-200">
                                <?php foreach ($users as $user): ?>
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-gray-100"><?= $user->getUsername() ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-200"><?= $user->getEmail()?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-200"><?= $user->getRole() ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-200"><?= $user->getCreatedAt() ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <a href="/content/admin/result/<?= $user->getId() ?>" class="text-blue-600 hover:text-blue-900 mr-3">View</a>
                                            <a href="/dashboard/user/edit/<?= $user->getId() ?>" class="text-indigo-600 dark:text-indigo-300 hover:text-indigo-900 mr-3">Edit</a>
